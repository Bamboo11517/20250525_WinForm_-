namespace _20250525_WinForm
{
    public partial class Form1 : Form
    {
        ...
        private void login_Click(object sender, EventArgs e)
        {
            try
            {
                if (sqlite.Login(this.txtUserid.Text, this.txtPass.Text) == true)
                if (string.IsNullOrEmpty(this.txtUserid.Text) == true || string.IsNullOrEmpty(this.txtPass.Text) == true)
