...

{
    ...
    public partial class ORDER : Form
    {
        ...
        public ORDER()
        {
            ...
            //注文情報リスト作成⇒リスト追加
            this.OrderInfoList.Add(new OrderInfo(cbxItem1, nudeItem1));
            this.OrderInfoList.Add(new OrderInfo(cbxItem2, nudeItem2));
            this.OrderInfoList.Add(new OrderInfo(cbxItem3, nudeItem3));
            this.OrderInfoList.Add(new OrderInfo(cbxItem4, nudeItem4));
            this.OrderInfoList.Add(new OrderInfo(cbxItem5, nudeItem5));
            this.OrderInfoList.Add(new OrderInfo(cbxItem6, nudeItem6));
            this.OrderInfoList.Add(new OrderInfo(cbxItem7, nudeItem7));
            this.OrderInfoList.Add(new OrderInfo(cbxItem8, nudeItem8));
            this.OrderInfoList.Add(new OrderInfo(cbxItem9, nudeItem9));
            this.OrderInfoList.Add(new OrderInfo(cbxItem10, nudeItem10));
        ...
        private void Order_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //届け先情報に会員情報の内容を設定
                txtDelName.Text = Member.Name;
                txtDelPos.Text = Member.PostCode;
                txtDelAdd.Text = Member.Address;
                txtDelTel.Text = Member.Telephone;

                //届け先(宛名)の全選択を外す
                this.txtDelName.SelectionStart = this.txtDelName.Text.Length;
        ...
        {
            if (this.cbxBillType.SelectedIndex == 1)
            {
                // 請求先情報エリアを有効化
                this.grpBill.Enabled = true;
            }
            else
            {
                // 請求先情報エリアを無効化
                this.grpBill.Enabled = false;
            }
        }
        ...
        private bool CheckBlank(ref string argMessage)
        {
            ...
            {
                //届け先情報の各入力項目を順番にチェック
                foreach (TextBox txtDelivery in new TextBox[] { txtDelName, txtDelPos, txtDelAdd, txtDelTel })
                {
                    //未入力項目あり
                ...
                {
                    //請求先情報の各入力項目を順番にチェック
                    foreach (TextBox txtBill in new TextBox[] { txtBillName, txtBillPos, txtBillAdd, txtBillTel })
                    {
                        //未入力項目あり
        ...
        private void grpDel_Enter(object sender, EventArgs e)
        {
        ...
        private void txtDelPos_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtDelAdd_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtDelTel_TextChanged(object sender, EventArgs e)
        {

        }

        private void grpBill_Enter(object sender, EventArgs e)
        {
        ...
        private void txtBillPos_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtBillTel_TextChanged(object sender, EventArgs e)
        {

        }

        private void grpBillType_Enter(object sender, EventArgs e)
        {

        }

        private void rdoSame_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void grpDeadLine_Enter(object sender, EventArgs e)
        {
        ...
        private void btnDelPosSearch_Click(object sender, EventArgs e)
        {

        }

        private void btnBillPosSreach_Click(object sender, EventArgs e)
        {
        ...
        private void cbxItem6_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void nudeItem1_ValueChanged(object sender, EventArgs e)
        {

        }

        private void cbxItem2_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void nudeItem6_ValueChanged(object sender, EventArgs e)
        {
